...
<body id="">
    <div class="row" style="height: 100vh; width: 100vw; margin: 0">
        <div class="col-12 container-form">
            <form id="form-register" method="POST" action="./../php/post/users/" autocomplete="off">
                <div class="form-cadastro-econoveg">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <span class="input">
                                <input class="input_field" type="password" autocomplete="off" name="password" id="password" required>
