...
function toggleEditProfile(toggle) {
    if (toggle) {
        $("#info_profile").addClass("hide");
        $("#update_profile").removeClass("hide");
    } else {
        $("#info_profile").removeClass("hide");
        $("#update_profile").addClass("hide");
    }
}

function verificar_data_nasc(data_nasc) {}

function setError(msg = "") {
    $("#msg_error").html(msg);
    if (msg != "") {
        $("#birth_date_profile").addClass("input_error");
        $("#div_error").addClass("show").removeClass("hide");
        // $("#btn-submit").addClass("hide").removeClass("show");
    } else {
        $("#birth_date_profile").removeClass("input_error");
...
function submit_form() {
    // if (data_nasc) {
    let data_nasc = $('#birth_date_profile').val();
    ...
    if (quantos_anos <= 16) {
        setError("Necessário no mínimo 16 anos");
    } else {
        setError();
